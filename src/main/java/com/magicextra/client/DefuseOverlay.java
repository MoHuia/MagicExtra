package com.magicextra.client;


import com.magicextra.MagicExtra;
import com.magicextra.event.KeyBindings;
...
public class DefuseOverlay implements IGuiOverlay {
    ...
    // 纹理资源路径（GUI图标图集）
    public final static ResourceLocation TEXTURE = new ResourceLocation(MagicExtra.MODID,"textures/gui/icons.png");
    // 进度条总宽度（包含边框）
